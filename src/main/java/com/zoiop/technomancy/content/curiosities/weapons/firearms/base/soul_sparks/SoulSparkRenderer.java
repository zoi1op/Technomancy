package com.zoiop.technomancy.content.curiosities.weapons.firearms.base.soul_sparks;
...
@OnlyIn(Dist.CLIENT)
public class SoulSparkRenderer extends EntityRenderer<SoulSparkEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("textures/particle/soul_fire_flame.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public SoulSparkRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }



    protected int getBlockLightLevel(SoulSparkEntity p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(SoulSparkEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
    ...
    public ResourceLocation getTextureLocation(SoulSparkEntity p_114078_) {
